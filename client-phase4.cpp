/*
-------------------------------------- PHASE 4 -------------------------------------------
Phase 2 followed by further search of files among two-hop neighbors.
Sends requests through immediate neighbors.
Accepts replies via new connections.
